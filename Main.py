...
command_str = f'mpiexec -n 1 python {server_python_file}  --data_pattern {data_pattern} --dataset_type {datatype} --epoch 150 --worker_num {worker_num} --data_path {data_path} --expname {expname} : -n {active_process_num} python {client_python_file} --expname {expname}'
print(command_str)
