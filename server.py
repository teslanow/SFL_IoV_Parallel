...
parser.add_argument('--data_path', type=str, default='/data/ymliao/data')
...
def main():
    ...
    _, test_dataset, train_data_partition, labels = partition_data(common_config.dataset_type, common_config.data_pattern, worker_num)
